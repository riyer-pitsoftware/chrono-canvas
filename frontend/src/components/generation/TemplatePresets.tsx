...
const PORTRAIT_PRESETS: PresetTemplate[] = [
  {
    ...
    prompt:
      'Leonardo da Vinci, the Renaissance polymath, seated in his workshop in Florence surrounded by sketches of flying machines and anatomical drawings',
    mood: 'warm',
    style: 'painterly',
    icon: '\uD83C\uDFA8',
    category: 'portrait',
  },
  {
    ...
    prompt:
      'Hatshepsut, the female pharaoh of Egypt, standing before her mortuary temple at Deir el-Bahari with the golden desert stretching behind her',
    mood: 'dramatic',
    style: 'cinematic',
    icon: '\uD83C\uDFDB\uFE0F',
    category: 'portrait',
  },
  {
    ...
    prompt:
      'Ada Lovelace, mathematician and writer, posed beside Charles Babbage\u2019s Analytical Engine in a grand Victorian study with gaslight illumination',
    mood: 'warm',
    style: 'noir',
    icon: '\uD83C\uDFF0',
    category: 'portrait',
...
export function TemplatePresets({ mode, onSelect, disabled }: TemplatePresetsProps) {
  ...
  return (
    <div className="mb-4">
      {showOnboarding && <OnboardingBanner mode={category} onDismiss={dismissOnboarding} />}

      <div className="mb-3 flex items-center gap-2">
        <p className="text-sm font-medium text-[var(--muted-foreground)]">Quick Start Templates</p>
